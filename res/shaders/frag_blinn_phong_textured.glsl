...
uniform bool u_None;
uniform bool u_AmbOnly;
uniform bool u_SpecOnly;
uniform bool u_AmbSpec;
...
void main() {
	...
	{
		result = (
		(ambient + diffuse + finalSpecular) * attenuation // light factors from our single light
